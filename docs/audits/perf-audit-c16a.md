...
**Cost on ClawdDesk:** Personal scale tops out at maybe 20-50 schedules realistically. At 50 the route returns in well under a millisecond. Not a problem.
...
**Cost on ClawdDesk:** UI debounces cron-input keystrokes at 200 ms (`public/app.js:2472`). Even a fast typist won't generate more than ~5 previews/sec. Server cost: ~750 µs/sec at peak, or ~0.075% of one CPU. Invisible.
